...
class Manager extends JFrame{
  ...
  val btnCRUDOperations = new JButton("CRUD Operations")
  val btnReportAndReceipts = new JButton("Reports & Receipts")
  val btnExit = new JButton("Exit Program")


  def createManagerGUI(): Unit ={
    ...
    val lblMsgLabel = new JLabel("Manager Operations")
...
object ManagerArea{
  def main(args: Array[String]): Unit = {
    val createManager = new Manager()
    createManager.createManagerGUI()
  }
}
